...
function BoxDashboard({
  ...
  useEffect(async () => {
    ...
    const semesters = selectiveProcesses.map(function (process) {
      return process.process_semester;
    });
    setSemestre(semesters);
    semestre;
  }, []);
